...
takes off — so it has something to prevent (see `examples/sia_campaigns.R` and
`examples/quarantine.R` for scheduled / leaky versions). We compare the *same* SIR model
